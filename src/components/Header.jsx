...
const Header = () => {
    ...
    return (
        <div className='w-full bg-gradient-to-b from-black to-transparent'>
            <div className='container mx-auto px-3 sm:px-4 py-3 sm:py-4 md:py-6 flex items-center justify-between'>
                <Link to="/" className='w-20 sm:w-24 md:w-32 lg:w-40 flex-shrink-0'>
